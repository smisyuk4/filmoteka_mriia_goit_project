 ...
 * limitations under the License.
 */
const T="firebase-heartbeat-store";let S=null;function C(){return S||(S=(0,s.openDB)("firebase-heartbeat-database",1,{upgrade:(t,e)=>{if(0===e)t.createObjectStore(T)}}).catch((t=>{throw x.create("idb-open",{originalErrorMessage:t.message})}))),S}async function A(t,e){var n;try{const n=(await C()).transaction(T,"readwrite"),i=n.objectStore(T);return await i.put(e,L(t)),n.done}catch(t){if(t instanceof a.FirebaseError)f.warn(t.message);else{const e=x.create("idb-set",{originalErrorMessage:null===(n=t)||void 0===n?void 0:n.message});f.warn(e.message)}}}function L(t){return`${t.name}!${t.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class Lt extends Tt{static credential(t,e){return xt._fromParams({providerId:Lt.PROVIDER_ID,signInMethod:Lt.TWITTER_SIGN_IN_METHOD,oauthToken:t,oauthTokenSecret:e})}static credentialFromResult(t){return Lt.credentialFromTaggedObject(t)}static credentialFromError(t){return Lt.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t)return null;const{oauthAccessToken:e,oauthTokenSecret:n}=t;if(!e||!n)return null;try{return Lt.credential(e,n)}catch(t){return null}}constructor(){super("twitter.com")}}Lt.TWITTER_SIGN_IN_METHOD="twitter.com",Lt.PROVIDER_ID="twitter.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zt(t,e,n=!1){const i="signIn",r=await Mt(t,i,e),o=await Rt._fromIdTokenResponse(t,i,r);return n||await t._updateCurrentUser(o.user),o}function Ft(t,e,n,r){return(0,i.getModularInstance)(t).onAuthStateChanged(e,n,r)}new WeakMap;const Ut="__sak";
/**
 * @license
 * Copyright 2019 Google LLC
 *
