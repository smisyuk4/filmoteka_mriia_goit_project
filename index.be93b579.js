 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eo{constructor(t,e=null,n=[],i=[],r=null,o=null,a=null){this.path=t,this.collectionGroup=e,this.orderBy=n,this.filters=i,this.limit=r,this.startAt=o,this.endAt=a,this.D=null}}function Io(t,e=null,n=[],i=[],r=null,o=null,a=null){return new Eo(t,e,n,i,r,o,a)}class No{constructor(t,e){this.position=t,this.inclusive=e}}class To{constructor(t,e="asc"){this.field=t,this.dir=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class So{constructor(t,e=null,n=[],i=[],r=null,o="F",a=null,s=null){this.path=t,this.collectionGroup=e,this.explicitOrderBy=n,this.filters=i,this.limit=r,this.limitType=o,this.startAt=a,this.endAt=s,this.O=null,this.k=null,this.startAt,this.endAt}}function Co(t){return t.explicitOrderBy.length>0?t.explicitOrderBy[0].field:null}function Ao(t){for(const e of t.filters)if(e.q())return e.field;return null}function Ro(t){const e=yr(t);if(null===e.O){e.O=[];const t=Ao(e),n=Co(e);if(null!==t&&null===n)t.isKeyField()||e.O.push(new To(t)),e.O.push(new To(Lr.keyField(),"asc"));else{let t=!1;for(const n of e.explicitOrderBy)e.O.push(n),n.field.isKeyField()&&(t=!0);if(!t){const t=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";e.O.push(new To(Lr.keyField(),t))}}}return e.O}function Lo(t){const e=yr(t);if(!e.k)if("F"===e.limitType)e.k=Io(e.path,e.collectionGroup,Ro(e),e.filters,e.limit,e.startAt,e.endAt);else{const t=[];for(const n of Ro(e)){const e="desc"===n.dir?"asc":"desc";t.push(new To(n.field,e))}const n=e.endAt?new No(e.endAt.position,e.endAt.inclusive):null,i=e.startAt?new No(e.startAt.position,e.startAt.inclusive):null;e.k=Io(e.path,e.collectionGroup,t,e.filters,e.limit,n,i)}return e.k}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ea{isEqual(t){return this._internalPath.isEqual(t._internalPath)}constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new br("invalid-argument","Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Lr(t)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ks(t,e){return t.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:t.tenantId}):e}async function _s(t,e,n,i,r={}){return Es(t,r,(async()=>{let r={},o={};i&&("GET"===e?o=i:r={body:JSON.stringify(i)});const a=oi(Object.assign({key:t.config.apiKey},o)).slice(1),s=await t._getAdditionalHeaders();return s["Content-Type"]="application/json",t.languageCode&&(s["X-Firebase-Locale"]=t.languageCode),vs.fetch()(Ns(t,t.config.apiHost,n,a),Object.assign({method:e,headers:s,referrerPolicy:"no-referrer"},r))}))}async function Es(t,e,n){t._canInitEmulator=!1;const i=Object.assign(Object.assign({},ws),e);try{const e=new Ts(t),r=await Promise.race([n(),e.promise]);e.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw Ss(t,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const e=r.ok?o.errorMessage:o.error.message,[n,a]=e.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw Ss(t,"credential-already-in-use",o);if("EMAIL_EXISTS"===n)throw Ss(t,"email-already-in-use",o);if("USER_DISABLED"===n)throw Ss(t,"user-disabled",o);const s=i[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(a)throw os(t,s,a);is(t,s)}}catch(e){if(e instanceof Zn)throw e;is(t,"network-request-failed")}}async function Is(t,e,n,i,r={}){const o=await _s(t,e,n,i,r);return"mfaPendingCredential"in o&&is(t,"multi-factor-auth-required",{_serverResponse:o}),o}function Ns(t,e,n,i){const r=`${e}${n}?${i}`;return t.config.emulator?bs(t.config,r):`${t.config.apiScheme}://${r}`}class Ts{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(t){this.auth=t,this.timer=null,this.promise=new Promise(((t,e)=>{this.timer=setTimeout((()=>e(rs(this.auth,"network-request-failed"))),xs.get())}))}}function Ss(t,e,n){const i={appName:t.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const r=rs(t,e,i);return r.customData._tokenResponse=n,r}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
return async function(t,e){return Is(t,"POST","/v1/accounts:signInWithPassword",ks(t,e))}(t,{returnSecureToken:!0,email:this._email,password:this._password});case"emailLink":
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
return async function(t,e){return Is(t,"POST","/v1/accounts:signInWithEmailLink",ks(t,e))}(t,{email:this._email,oobCode:this._password});default:is(t,"internal-error")}}async _linkToIdToken(t,e){switch(this.signInMethod){case"password":return cl(t,{idToken:e,returnSecureToken:!0,email:this._email,password:this._password});case"emailLink":return async function(t,e){return Is(t,"POST","/v1/accounts:signInWithEmailLink",ks(t,e))}(t,{idToken:e,email:this._email,oobCode:this._password});default:is(t,"internal-error")}}_getReauthenticationResolver(t){return this._getIdTokenResponse(t)}constructor(t,e,n,i=null){super("password",n),this._email=t,this._password=e,this._tenantId=i}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function dl(t,e){return Is(t,"POST","/v1/accounts:signInWithIdp",ks(t,e))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class pl extends ll{static _fromVerification(t,e){return new pl({verificationId:t,verificationCode:e})}static _fromTokenResponse(t,e){return new pl({phoneNumber:t,temporaryProof:e})}_getIdTokenResponse(t){return async function(t,e){return Is(t,"POST","/v1/accounts:signInWithPhoneNumber",ks(t,e))}(t,this._makeVerificationRequest())}_linkToIdToken(t,e){return async function(t,e){const n=await Is(t,"POST","/v1/accounts:signInWithPhoneNumber",ks(t,e));if(n.temporaryProof)throw Ss(t,"account-exists-with-different-credential",n);return n}(t,Object.assign({idToken:e},this._makeVerificationRequest()))}_getReauthenticationResolver(t){return async function(t,e){return Is(t,"POST","/v1/accounts:signInWithPhoneNumber",ks(t,Object.assign(Object.assign({},e),{operation:"REAUTH"})),hl)}(t,this._makeVerificationRequest())}_makeVerificationRequest(){const{temporaryProof:t,phoneNumber:e,verificationId:n,verificationCode:i}=this.params;return t&&e?{temporaryProof:t,phoneNumber:e}:{sessionInfo:n,code:i}}toJSON(){const t={providerId:this.providerId};return this.params.phoneNumber&&(t.phoneNumber=this.params.phoneNumber),this.params.temporaryProof&&(t.temporaryProof=this.params.temporaryProof),this.params.verificationCode&&(t.verificationCode=this.params.verificationCode),this.params.verificationId&&(t.verificationId=this.params.verificationId),t}static fromJSON(t){"string"==typeof t&&(t=JSON.parse(t));const{verificationId:e,verificationCode:n,phoneNumber:i,temporaryProof:r}=t;return n||e||i||r?new pl({verificationId:e,verificationCode:n,phoneNumber:i,temporaryProof:r}):null}constructor(t){super("phone","phone"),this.params=t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class _l{static async _fromIdTokenResponse(t,e,n,i=!1){const r=await zs._fromIdTokenResponse(t,n,i),o=El(n);return new _l({user:r,providerId:o,_tokenResponse:n,operationType:e})}static async _forOperation(t,e,n){await t._updateTokensIfNecessary(n,!0);const i=El(n);return new _l({user:t,providerId:i,_tokenResponse:n,operationType:e})}constructor(t){this.user=t.user,this.providerId=t.providerId,this._tokenResponse=t._tokenResponse,this.operationType=t.operationType}}function El(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Il extends Zn{static _fromErrorAndOperation(t,e,n,i){return new Il(t,e,n,i)}constructor(t,e,n,i){var r;super(e.code,e.message),this.operationType=n,this.user=i,Object.setPrototypeOf(this,Il.prototype),this.customData={appName:t.name,tenantId:null!==(r=t.tenantId)&&void 0!==r?r:void 0,_serverResponse:e.customData._serverResponse,operationType:n}}}function Nl(t,e,n,i){return("reauthenticate"===e?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch((n=>{if("auth/multi-factor-auth-required"===n.code)throw Il._fromErrorAndOperation(t,n,e,i);throw n}))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tl(t,e,n=!1){const i=await Ls(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return _l._forOperation(t,"link",i)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Sl(t,e,n=!1){var i;const{auth:r}=t,o="reauthenticate";try{const i=await Ls(t,Nl(r,o,e,t),n);ls(i.idToken,r,"internal-error");const a=Rs(i.idToken);ls(a,r,"internal-error");const{sub:s}=a;return ls(t.uid===s,r,"user-mismatch"),_l._forOperation(t,o,i)}catch(t){throw"auth/user-not-found"===(null===(i=t)||void 0===i?void 0:i.code)&&is(r,"user-mismatch"),t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _c=new ys(5e3,15e3),Ec={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ic=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Nc(t){const e=t.config;ls(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?bs(e,"emulator/auth/iframe"):`https://${t.config.authDomain}/__/auth/iframe`,i={apiKey:e.apiKey,appName:t.name,v:"9.14.0"},r=Ic.get(t.config.apiHost);r&&(i.eid=r);const o=t._getFrameworks();return o.length&&(i.fw=o.join(",")),`${n}?${oi(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const Tc={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"};class Sc{close(){if(this.window)try{this.window.close()}catch(t){}}constructor(t){this.window=t,this.associatedEvent=null}}function Cc(t,e,n,i=500,r=600){const o=Math.max((window.screen.availHeight-r)/2,0).toString(),a=Math.max((window.screen.availWidth-i)/2,0).toString();let s="";const l=Object.assign(Object.assign({},Tc),{width:i.toString(),height:r.toString(),top:o,left:a}),c=Wn().toLowerCase();n&&(s=qs(c)?"_blank":n),Hs(c)&&(e=e||"http://localhost",l.scrollbars="yes");const u=Object.entries(l).reduce(((t,[e,n])=>`${t}${e}=${n},`),"");if(function(t=Wn()){var e;return Qs(t)&&!!(null===(e=window.navigator)||void 0===e?void 0:e.standalone)}(c)&&"_self"!==s)return function(t,e){const n=document.createElement("a");n.href=t,n.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
