const ua = {
  ...
  war: "Війна",
  western: "Вестерн",
  footer: "©  2022 | Усі права захищено | <span class=rights-item >Розроблено за допомогою<span class=icon-heart><svg width=14 height=13><use href=/icons.e58dda3e.svg#icon-heart></use><svg></span><span id=modal-team-Btn class=students-link>студентами GoIT</span></span>",
  team: "МРІЯ",
...
const eng = {
  ...
  war: "War",
  western: "Western",
  footer: "©  2022 | All Rights Reserved | <span class=rights-item >Developed with <span class=icon-heart><svg width=14 height=13><use href=/icons.e58dda3e.svg#icon-heart></use><svg></span>by <span id=modal-team-Btn   class=students-link  >GoIT Students</span></span>",
  team: "MRIIA",
  teamLaed: "Team Lead",
  scrumMaster: "Scrum Master",
  developer: "Developer",
  dev1: "Serhiy Misiuk",
  dev2: "Olena Wednesday",
