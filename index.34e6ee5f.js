 ...
 * limitations under the License.
 */
const T="firebase-heartbeat-store";let S=null;function C(){return S||(S=(0,s.openDB)("firebase-heartbeat-database",1,{upgrade:(t,e)=>{if(0===e)t.createObjectStore(T)}}).catch((t=>{throw x.create("idb-open",{originalErrorMessage:t.message})}))),S}async function A(t,e){var n;try{const n=(await C()).transaction(T,"readwrite"),i=n.objectStore(T);return await i.put(e,R(t)),n.done}catch(t){if(t instanceof a.FirebaseError)f.warn(t.message);else{const e=x.create("idb-set",{originalErrorMessage:null===(n=t)||void 0===n?void 0:n.message});f.warn(e.message)}}}function R(t){return`${t.name}!${t.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class I extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name="FirebaseError",Object.setPrototypeOf(this,I.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,E.prototype.create)}}class E{create(t,...e){const n=e[0]||{},i=`${this.service}/${t}`,r=this.errors[t],o=r?function(t,e){return t.replace(T,((t,n)=>{const i=e[n];return null!=i?String(i):`<${n}?>`}))}(r,n):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new I(i,a,n)}constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}}const T=/\{\$([^}]+)}/g;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class O{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class D{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable((()=>e(l.UNAUTHENTICATED)))}shutdown(){}}class M{getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable((()=>e(this.token.user)))}shutdown(){this.changeListener=null}constructor(t){this.token=t,this.changeListener=null}}class P{getToken(){return this.auth?this.auth.getToken().then((t=>t?(g("string"==typeof t.accessToken),new O(t.accessToken,new l(this.auth.getUid()))):null)):Promise.resolve(null)}invalidateToken(){}start(t,e){}shutdown(){}constructor(t){this.auth=null,t.onInit((t=>{this.auth=t}))}}class B{l(){return this.u?this.u():(g(!("object"!=typeof this.t||null===this.t||!this.t.auth||!this.t.auth.getAuthHeaderValueForFirstParty)),this.t.auth.getAuthHeaderValueForFirstParty([]))}get headers(){this.h.set("X-Goog-AuthUser",this.i);const t=this.l();return t&&this.h.set("Authorization",t),this.o&&this.h.set("X-Goog-Iam-Authorization-Token",this.o),this.h}constructor(t,e,n,i){this.t=t,this.i=e,this.o=n,this.u=i,this.type="FirstParty",this.user=l.FIRST_PARTY,this.h=new Map}}class z{getToken(){return Promise.resolve(new B(this.t,this.i,this.o,this.u))}start(t,e){t.enqueueRetryable((()=>e(l.FIRST_PARTY)))}shutdown(){}invalidateToken(){}constructor(t,e,n,i){this.t=t,this.i=e,this.o=n,this.u=i}}class F{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class U{getToken(){return this.appCheck?this.appCheck.getToken().then((t=>t?(g("string"==typeof t.token),new F(t.token)):null)):Promise.resolve(null)}invalidateToken(){}start(t,e){}shutdown(){}constructor(t){this.m=t,this.appCheck=null,t.onInit((t=>{this.appCheck=t}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bt{constructor(t,e=null,n=[],i=[],r=null,o=null,a=null){this.path=t,this.collectionGroup=e,this.orderBy=n,this.filters=i,this.limit=r,this.startAt=o,this.endAt=a,this.D=null}}function zt(t,e=null,n=[],i=[],r=null,o=null,a=null){return new Bt(t,e,n,i,r,o,a)}class Ft{constructor(t,e){this.position=t,this.inclusive=e}}class Ut{constructor(t,e="asc"){this.field=t,this.dir=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{isEqual(t){return this._internalPath.isEqual(t._internalPath)}constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new L(w,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new q(t)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function sn(t,e,n){let i;return i=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,i}class ln extends class{convertValue(t,e="none"){switch(Ct(t)){case 0:return null;case 1:return t.booleanValue;case 2:return Nt(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(It(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 10:return this.convertObject(t.mapValue,e);default:throw m()}}convertObject(t,e){const n={};return ht(t.fields,((t,i)=>{n[t]=this.convertValue(i,e)})),n}convertGeoPoint(t){return new Fe(Nt(t.latitude),Nt(t.longitude))}convertArray(t,e){return(t.values||[]).map((t=>this.convertValue(t,e)))}convertServerTimestamp(t,e){switch(e){case"previous":const n=Tt(t);return null==n?null:this.convertValue(n,e);case"estimate":return this.convertTimestamp(St(t));default:return null}}convertTimestamp(t){const e=_t(t);return new ut(e.seconds,e.nanos)}convertDocumentKey(t,e){const n=$.fromString(t);g(ke(n));const i=new W(n.get(1),n.get(3)),r=new X(n.popFirst(5));return i.isEqual(e)||d(`Document ${r} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),r}}{convertBytes(t){return new Pe(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Re(this.firestore,null,e)}constructor(t){super(),this.firestore=t}}function cn(t){!function(t){if("L"===t.limitType&&0===t.explicitOrderBy.length)throw new L(C,"limitToLast() queries require specifying at least one orderBy() clause")}((t=Y(t,Le))._query);const e=Te(t.firestore),n=new ln(t.firestore);return async function(t,e){const n=y(t),i=ye(n.L,Ht(e));return(await n.P("RunQuery",i.parent,{structuredQuery:i.structuredQuery})).filter((t=>!!t.document)).map((t=>function(t,e,n){const i=he(t,e.name),r=ue(e.updateTime),o=new Mt({mapValue:{fields:e.fields}});return Pt.newFoundDocument(i,r,o)}(n.L,t.document)))}(e,t._query).then((e=>{const i=e.map((e=>new rn(t.firestore,n,e.key,e,t.converter)));return"L"===t._query.limitType&&i.reverse(),new on(t,i)}))}function un(t,e,n){const i=sn((t=Y(t,Re)).converter,e,n),r=qe(He(t.firestore),"setDoc",t._key,i,null!==t.converter,n);return Ie(Te(t.firestore),[r.toMutation(t._key,Yt.none())])}var fn;fn=`${i.SDK_VERSION}_lite`,c=fn,(0,i._registerComponent)(new(0,r.Component)("firestore/lite",((t,{instanceIdentifier:e,options:n})=>{const i=t.getProvider("app").getImmediate(),r=new Ce(new P(t.getProvider("auth-internal")),new U(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new L(w,'"projectId" not provided in firebase.initializeApp.');return new W(t.options.projectId,e)}(i,e),i);return n&&r._setSettings(n),r}),"PUBLIC").setMultipleInstances(!0)),(0,i.registerVersion)("firestore-lite","3.7.3",""),(0,i.registerVersion)("firestore-lite","3.7.3","esm2017")})),o.register("amyG6",(function(e,n){t(e.exports,"signInWithPopup",(function(){return o("30XCk").c})),t(e.exports,"GoogleAuthProvider",(function(){return o("30XCk").Q})),t(e.exports,"getAuth",(function(){return o("30XCk").n})),t(e.exports,"onAuthStateChanged",(function(){return o("30XCk").v})),o("1iO0g")})),o.register("1iO0g",(function(e,n){t(e.exports,"GoogleAuthProvider",(function(){return o("30XCk").Q})),t(e.exports,"getAuth",(function(){return o("30XCk").n})),t(e.exports,"onAuthStateChanged",(function(){return o("30XCk").v})),t(e.exports,"signInWithPopup",(function(){return o("30XCk").c})),o("ffjl9"),o("ix4Jr"),o("7vF8m"),o("4a6xH");o("30XCk")})),o.register("30XCk",(function(e,n){t(e.exports,"Q",(function(){return Ct})),t(e.exports,"v",(function(){return Ft})),t(e.exports,"c",(function(){return ve})),t(e.exports,"n",(function(){return tn}));var i=o("ffjl9"),r=o("ix4Jr"),a=o("7vF8m"),s=o("l73V3"),l=o("4a6xH");function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const u=c,f=new(0,i.ErrorFactory)("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),d=new(0,a.Logger)("@firebase/auth");function h(t,...e){d.logLevel<=a.LogLevel.ERROR&&d.error(`Auth (${r.SDK_VERSION}): ${t}`,...e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ct extends Tt{static credential(t,e){return xt._fromParams({providerId:Ct.PROVIDER_ID,signInMethod:Ct.GOOGLE_SIGN_IN_METHOD,idToken:t,accessToken:e})}static credentialFromResult(t){return Ct.credentialFromTaggedObject(t)}static credentialFromError(t){return Ct.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t)return null;const{oauthIdToken:e,oauthAccessToken:n}=t;if(!e&&!n)return null;try{return Ct.credential(e,n)}catch(t){return null}}constructor(){super("google.com"),this.addScope("profile")}}Ct.GOOGLE_SIGN_IN_METHOD="google.com",Ct.PROVIDER_ID="google.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pt(t,e,n=!1){const i=await W(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Lt._forOperation(t,"link",i)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Bt(t,e,n=!1){var i;const{auth:r}=t,o="reauthenticate";try{const i=await W(t,Mt(r,o,e,t),n);v(i.idToken,r,"internal-error");const a=j(i.idToken);v(a,r,"internal-error");const{sub:s}=a;return v(t.uid===s,r,"user-mismatch"),Lt._forOperation(t,o,i)}catch(t){throw"auth/user-not-found"===(null===(i=t)||void 0===i?void 0:i.code)&&p(r,"user-mismatch"),t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zt(t,e,n=!1){const i="signIn",r=await Mt(t,i,e),o=await Lt._fromIdTokenResponse(t,i,r);return n||await t._updateCurrentUser(o.user),o}function Ft(t,e,n,r){return(0,i.getModularInstance)(t).onAuthStateChanged(e,n,r)}new WeakMap;const Ut="__sak";
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $t extends jt{_addListener(t,e){}_removeListener(t,e){}constructor(){super((()=>window.sessionStorage),"SESSION")}}$t.type="SESSION";const Ht=$t;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const xe=new Map;class ke extends ye{async execute(){let t=xe.get(this.auth._key());if(!t){try{const e=await async function(t,e){const n=Ie(e),i=Ne(t);if(!await i._isAvailable())return!1;const r="true"===await i._get(n);return await i._remove(n),r}(this.resolver,this.auth)?await super.execute():null;t=()=>Promise.resolve(e)}catch(e){t=()=>Promise.reject(e)}xe.set(this.auth._key(),t)}return this.bypassAuthState||xe.set(this.auth._key(),(()=>Promise.resolve(null))),t()}async onAuthEvent(t){if("signInViaRedirect"===t.type)return super.onAuthEvent(t);if("unknown"!==t.type){if(t.eventId){const e=await this.auth._redirectUserForId(t.eventId);if(e)return this.user=e,super.onAuthEvent(t);this.resolve(null)}}else this.resolve(null)}async onExecution(){}cleanUp(){}constructor(t,e,n=!1){super(t,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],e,void 0,n),this.eventId=null}}function _e(t,e){xe.set(t._key(),e)}function Ne(t){return _(t._redirectPersistence)}function Ie(t){return J("pendingRedirect",t.config.apiKey,t.name)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const De=new T(3e4,6e4);function Me(){const t=Gt().___jsl;if(null==t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let e=0;e<t.CP.length;e++)t.CP[e]=null}let Pe=null;function Be(t){return Pe=Pe||function(t){return new Promise(((e,n)=>{var i,r,o;function a(){Me(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Me(),n(m(t,"network-request-failed"))},timeout:De.get()})}if(null===(r=null===(i=Gt().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)e(gapi.iframes.getContext());else{if(!(null===(o=Gt().gapi)||void 0===o?void 0:o.load)){const e=le("iframefcb");return Gt()[e]=()=>{gapi.load?a():n(m(t,"network-request-failed"))},se(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}a()}})).catch((t=>{throw Pe=null,t}))}(t),Pe}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ze=new T(5e3,15e3),Fe={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ue=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function je(t){const e=t.config;v(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?S(e,"emulator/auth/iframe"):`https://${t.config.authDomain}/__/auth/iframe`,o={apiKey:e.apiKey,appName:t.name,v:r.SDK_VERSION},a=Ue.get(t.config.apiHost);a&&(o.eid=a);const s=t._getFrameworks();return s.length&&(o.fw=s.join(",")),`${n}?${(0,i.querystring)(o).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e||"",l),new Ve(null);const d=window.open(e||"",l,f);v(d,t,"popup-blocked");try{d.focus()}catch(t){}return new Ve(d)}const He="emulator/auth/handler";function qe(t,e,n,o,a,s){v(t.config.authDomain,t,"auth-domain-config-required"),v(t.config.apiKey,t,"invalid-api-key");const l={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:o,v:r.SDK_VERSION,eventId:a};if(e instanceof Et){e.setDefaultLanguage(t.languageCode),l.providerId=e.providerId||"",(0,i.isEmpty)(e.getCustomParameters())||(l.customParameters=JSON.stringify(e.getCustomParameters()));for(const[t,e]of Object.entries(s||{}))l[t]=e}if(e instanceof Tt){const t=e.getScopes().filter((t=>""!==t));t.length>0&&(l.scopes=t.join(","))}t.tenantId&&(l.tid=t.tenantId);const c=l;for(const t of Object.keys(c))void 0===c[t]&&delete c[t];return`${function({config:t}){return t.emulator?S(t,He):`https://${t.authDomain}/__/auth/handler`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t)}?${(0,i.querystring)(c).slice(1)}`}const Xe="webStorageSupport";const Ke=class{async _openPopup(t,e,n,i){var r;x(null===(r=this.eventManagers[t._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return $e(t,qe(t,e,n,N(),i),Xt())}async _openRedirect(t,e,n,i){var r;return await this._originValidation(t),r=qe(t,e,n,N(),i),Gt().location.href=r,new Promise((()=>{}))}_initialize(t){const e=t._key();if(this.eventManagers[e]){const{manager:t,promise:n}=this.eventManagers[e];return t?Promise.resolve(t):(x(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(t);return this.eventManagers[e]={promise:n},n.catch((()=>{delete this.eventManagers[e]})),n}async initAndGetManager(t){const e=await async function(t){const e=await Be(t),n=Gt().gapi;return v(n,t,"internal-error"),e.open({where:document.body,url:je(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Fe,dontclear:!0},(e=>new Promise((async(n,i)=>{await e.restyle({setHideOnLeave:!1});const r=m(t,"network-request-failed"),o=Gt().setTimeout((()=>{i(r)}),ze.get());function a(){Gt().clearTimeout(o),n(e)}e.ping(a).then(a,(()=>{i(r)}))}))))}(t),n=new Te(t);return e.register("authEvent",(e=>{v(null==e?void 0:e.authEvent,t,"invalid-auth-event");return{status:n.onEvent(e.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[t._key()]={manager:n},this.iframes[t._key()]=e,n}_isIframeWebStorageSupported(t,e){this.iframes[t._key()].send(Xe,{type:Xe},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&e(!!r),p(t,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(t){const e=t._key();return this.originValidationPromises[e]||(this.originValidationPromises[e]=Le(t)),this.originValidationPromises[e]}get _shouldInitProactively(){return lt()||et()||st()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ht,this._completeRedirectFn=Ee,this._overrideRedirectResult=_e}};var Ge="@firebase/auth",Qe="0.20.11";
/**
 * @license
 * Copyright 2020 Google LLC
 *
